...
/* Watchdog (Window) Timeout Period */
typedef enum WDWP_enum {
	WDWP_8CLK_gc   = (0x00 << 4), /* 8 cycles (8ms @ 3.3V) */
	WDWP_16CLK_gc  = (0x01 << 4), /* 16 cycles (16ms @ 3.3V) */
	WDWP_32CLK_gc  = (0x02 << 4), /* 32 cycles (32ms @ 3.3V) */
	WDWP_64CLK_gc  = (0x03 << 4), /* 64 cycles (64ms @ 3.3V) */
	WDWP_128CLK_gc = (0x04 << 4), /* 128 cycles (0.125s @ 3.3V) */
	WDWP_256CLK_gc = (0x05 << 4), /* 256 cycles (0.25s @ 3.3V) */
	WDWP_512CLK_gc = (0x06 << 4), /* 512 cycles (0.5s @ 3.3V) */
	WDWP_1KCLK_gc  = (0x07 << 4), /* 1K cycles (1s @ 3.3V) */
	WDWP_2KCLK_gc  = (0x08 << 4), /* 2K cycles (2s @ 3.3V) */
	WDWP_4KCLK_gc  = (0x09 << 4), /* 4K cycles (4s @ 3.3V) */
	WDWP_8KCLK_gc  = (0x0A << 4), /* 8K cycles (8s @ 3.3V) */
} WDWP_t;
...
#define USB_BUSEVENT_vect                                                                                              \
	_VECTOR(125) /* SOF, suspend, resume, reset bus event interrupts, crc, underflow, overflow and stall error         \
	                interrupts */
